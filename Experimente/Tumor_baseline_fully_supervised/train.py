...
writer = SummaryWriter("runs/unet_0")
...
path_to_gt = "G:\\medical_decathlon_dataset\\Task01_BrainTumour\\gts_reduced"
gt_to_image_path = lambda gt: gt.replace("gts_reduced\\gt_", "images\\image_")
start = 0
end = .3
shuffle = True
repeat = False
