...
writer = SummaryWriter("runs/tumor_box_i_0")
...
path_to_gt = "G:\\medical_decathlon_dataset\\Task01_BrainTumour\\boxes_i"
gt_to_image_path = lambda gt: gt.replace("boxes_i\\gt_", "images\\image_")
start = 0
end = .3
shuffle = True
repeat = False
