...
writer = SummaryWriter("runs/augmented_iteration_1_" + str(datetime.now()).replace(':', '_'))
...
map_ids = False
augment = True
dataset = Dataset(path_to_gt, gt_to_image_path, start, end, batchSize, shuffle, map_ids, augment)
